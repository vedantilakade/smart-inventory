...
<html lang="en">
  <head>
    ...
    <!-- Add the CSS defined above -->
    <style>
      /* Hide the logout button in the sidebar by default */
      #sidebar-logout {
        display: none;
      }

      /* Show the logout button in the sidebar on small screens */
      @media (max-width: 991px) { /* Bootstrap's lg breakpoint is 992px */
        #sidebar-logout {
          display: block;
        }
      }
